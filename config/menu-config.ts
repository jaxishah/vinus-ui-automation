export const MENU_CONFIG = {
    beforeLogin: [
        ...
        },
        {
            ...
            submenu: [
                { name: 'BT1 스포츠', link: "javascript:openGameUrl('/game-sports/bt1?plus=','sports','bt1')" },
                { name: 'BT1 스포츠 S+', link: "javascript:openGameUrl('/game-sports/bt1?plus=yes','sports','bt1splus')" },
                { name: '국내형 스포츠', link: "javascript:openGameUrl('/game-sports/multi?sport=&seq=league','sports','sports')" },
                { name: '유럽형 스포츠', link: "javascript:openGameUrl('/game-sports/europe?sport=&seq=league','sports','sports2')" },
                { name: '라이브 스포츠', link: "javascript:openGameUrl('/game-sports/live-sport?sport=&seq=time','sports','livesports')" }
            ]
        },
        {
            name: '아케이드',
